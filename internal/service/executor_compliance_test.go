...
func TestExecutorFileApprovalRoundTrip(t *testing.T) {
	...
	firstRun, err := sendStreamingEvents(ctx, t, h.handler, &a2a.SendMessageRequest{
...
func TestExecutorContinuesPausedTaskOnSameThread(t *testing.T) {
	...
	root := mustSendTask(ctx, t, h.handler, a2a.NewMessage(a2a.MessageRoleUser, a2a.NewTextPart("REMEMBER root")))
	reuse := a2a.NewMessageForTask(a2a.MessageRoleUser, root.TaskInfo(), a2a.NewTextPart("WHAT_DO_YOU_REMEMBER"))
